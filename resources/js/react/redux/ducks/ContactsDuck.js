...
const fetch_contacts_url = `/api/users`;
...
const CONTACTS_FETCHED = 'messenger/contacts/contacts_fetched';
const CONTACTS_ADDED = 'messenger/contacts/contacts_added';
const CONTACTS_DELETED = 'messenger/contacts/contacts_deleted';
const CONTACTS_UPDATED = 'messenger/contacts/contacts_updated';

const LOADING_TRUE = 'messenger/contacts/loading_true';
const LOADING_FALSE = 'messenger/contacts/loading_false';
const FETCHING_TRUE = 'messenger/contacts/fetching_true';
const FETCHING_FALSE = 'messenger/contacts/fetching_false';
const SET_ERRORS = 'messenger/contacts/set_errors';
